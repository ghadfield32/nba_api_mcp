    ...
    async def _update_access_metadata(self, endpoint: str, file_hash: str):
        ...
        try:
            ...
            if file_hash in manifest["files"]:
                manifest["files"][file_hash]["last_accessed"] = datetime.now(
                    timezone.utc
                ).isoformat()
        ...
        try:
            ...
            for entry in entries:
                ...
                if cache_path.exists():
                    ...
                    await self._remove_from_manifest(
                        entry["endpoint"], entry["file_hash"]
                    )
    ...
    def get_stats(self) -> dict:
        ...
        try:
            ...
            return {
                ...
                "usage_pct": (total_size / (self.config.max_size_mb * 1024 * 1024))
                * 100,
                "endpoints": endpoints,
                "compression": self.config.compression,
            }
