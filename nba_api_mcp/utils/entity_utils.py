...
def resolve_flexible_input(
    value: Optional[Union[int, str]], entity_type: str, param_name: str = "entity"
) -> Optional[int]:
    """
    ...
    if isinstance(value, str):
        ...
        from nba_api_mcp.api.entity_resolver import resolve_player, resolve_team
        ...
        if entity_type == "player":
            ...
            raise ValueError(
                f"Invalid entity_type: {entity_type}. Must be 'player' or 'team'."
            )
