...
Usage:
    from nba_api_mcp.api.headers import get_nba_headers

    # Use in requests
    response = requests.get(url, headers=get_nba_headers())

    # Or access specific headers
    from nba_api_mcp.api.headers import NBA_USER_AGENT, NBA_REFERER
"""
...
def print_header_config():
    ...
    Example:
        >>> from nba_api_mcp.api.headers import print_header_config
        >>> print_header_config()
