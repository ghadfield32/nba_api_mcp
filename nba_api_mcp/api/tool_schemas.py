...
Usage:
    from nba_api_mcp.api.tool_schemas import FetchPlayerGamesInput, FetchPlayerGamesOutput
...
class FetchPlayerGamesInput(BaseModel):
    ...
    outcome: Optional[OutcomeType] = Field(
        None,
        description=(
            "Filter by game outcome. " "'W' = wins only, 'L' = losses only. " "Optional"
        ),
    )
    ...
    class Config:
        json_schema_extra = {
            "examples": [
                {"season": "2023-24", "player": "LeBron James", "last_n_games": 10},
                {
                    "season": "2024-25",
                    "player": 201939,
    ...
    def validate_season_format(cls, v: str) -> str:
        ...
        if len(v) == 7 and v[4] == "-":
            ...
            if (
                ...
                return v
        raise ValueError(
            f"Invalid season format: {v}. Expected 'YYYY-YY' (e.g., '2023-24')"
        )
    ...
    class Config:
        json_schema_extra = {
            "examples": [
                ...
                {"entity_type": "team", "entity_name": "Lakers", "season": "2024-25"},
            ]
        }
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "metadata": {"version": "v1", "timestamp": "2025-01-30T12:34:56Z"},
            }
        }
